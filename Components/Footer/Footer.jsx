          ...
          <div className='col-sm-12 col-md'>
            <div className='ftco-footer-widget mb-4 ml-md-4'>
              ...
              <ul className='list-unstyled'>
                <li>
                  <a href='#'>
                    <span className='fa fa-chevron-right mr-2'></span>Affiliate
                    Program
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href='#'>
                    <span className='fa fa-chevron-right mr-2'></span>Education
                    Services
                  </a>
                </li>
                <li>
                  <a href='#'>
                    <span className='fa fa-chevron-right mr-2'></span>Gift Cards
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className='col-sm-12 col-md'>
            <div className='ftco-footer-widget mb-4 ml-md-4'>
              ...
              <ul className='list-unstyled'>
                <li>
                  <a href='#'>
                    <span className='fa fa-chevron-right mr-2'></span>Join us
                  </a>
                </li>
                <li>
                  <a href='#'>
                    ...
                    <a href='#'>
                      ...
                      <span className='text'>
                        <span
                          ...
                          data-cfemail='adc4c3cbc2edd4c2d8dfc9c2c0ccc4c383cec2c0'
                        >
                          [email&#160;protected]
                        </span>
                      </span>
